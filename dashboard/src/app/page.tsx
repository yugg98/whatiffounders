...
export default function Page() {
  ...
  useEffect(() => {
    axios.get('http://localhost:8000/api/v1/news/get').then(res=>{
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {news.map((data) => (
                    <tr key={data.title}>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{data.description}</td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{data.desc}</td>
