                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        item.current ? '' : 'text-gray-700 hover:bg-gray-50',
                  ...
                  <nav className="isolate flex divide-x divide-gray-200 rounded-lg shadow" aria-label="Tabs">
                    {tabs.map((tab, tabIdx) => (
                      <a
                        ...
                        className={classNames(
                          tab.current ? 'text-gray-900 shadow-brutal' : 'text-gray-500 hover:text-gray-700',
                      ...
                      >
                        ...
                        <span
                          aria-hidden="true"
                          className={classNames(
                            tab.current ? 'shadow-brutal' : 'bg-transparent',
              ...
              <div className="mt-4">
                ...
                <ul role="list" className="space-y-4">
                  {questions.map((question) => (
                    <li key={question.id} className="bg-white px-4 py-6  hover:shadow-none rounded-sm transition-all ease-in-out duration-150 shadow-brutal border-2 border-black sm:p-6">
